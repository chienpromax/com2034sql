...
(1,1, 'like',N'Nhà trọ tốt'),
(2,2, 'dislike',N'Giá ổn'),
(3,3,'like',N'Nhà đẹp'),
(4,4, 'dislike',N'Cổng cao'),
(5,3, 'like',N'Xuống cấp'),
(6,4, 'dislike',N'Giá cao'),
(7,2, 'like',N'Đường xấu'),
(8,1, 'dislike',N'Nhà đẹp'),
(9,2, 'like',N'Mạng kém'),
(10,3,'dislike',N'Ngõ rộng')
